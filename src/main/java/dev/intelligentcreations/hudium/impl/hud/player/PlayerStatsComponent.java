...
public class PlayerStatsComponent {
    public void render(GuiGraphics guiGraphics, @NotNull PlayerEntity player, float tickDelta, Phys.Position position) {
        ...
        guiGraphics.drawShadowedText(textRenderer, String.valueOf(health), m - healthTextWidth, n, ColorUtil.convertColor("FFFFFF"));
        //Hunger
        ...
        guiGraphics.drawShadowedText(textRenderer, String.valueOf(hunger), o, n, ColorUtil.convertColor("FFFFFF"));
        //Saturation
        int saturation = MathHelper.ceil(hungerManager.getSaturationLevel());
        guiGraphics.drawShadowedText(textRenderer, String.valueOf(saturation), o + hungerTextWidth + 4, n, ColorUtil.convertColor("FFFFFF"));
        //Food
        ...
        if (mainHandStack.isFood()) {
            ...
            guiGraphics.drawShadowedText(textRenderer, String.valueOf(stackFoodLevel), o, n + 10, 8453920);
            guiGraphics.drawShadowedText(textRenderer, String.valueOf(stackSaturationLevel), o + hungerTextWidth + 4, n + 10, 8453920);
        }
        //Armor
        int armor = player.getArmor();
        if (armor > 0) {
            int armorTextWidth = textRenderer.getWidth(String.valueOf(armor));
            guiGraphics.drawShadowedText(textRenderer, String.valueOf(armor), m - armorTextWidth, n - 9, ColorUtil.convertColor("FFFFFF"));
        }
        //Air
        int air = player.getAir();
        if (air < 300) {
            guiGraphics.drawShadowedText(textRenderer, String.valueOf(air), o, n - 9, ColorUtil.convertColor("FFFFFF"));
        }
    }
